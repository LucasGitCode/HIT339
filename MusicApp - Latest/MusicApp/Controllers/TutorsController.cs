...
namespace MusicApp.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(MusicAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName")] Tutors tutors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName")] Tutors tutors)
        {
            if (id != tutors.Id)
            {
                return NotFound();
