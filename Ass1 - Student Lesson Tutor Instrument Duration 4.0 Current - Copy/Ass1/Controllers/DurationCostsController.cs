...
namespace Ass1.Controllers
{
    public class DurationCostsController : Controller
    {
        ...
        public DurationCostsController(Ass1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Duration,Cost")] DurationCost durationCost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Duration,Cost")] DurationCost durationCost)
        {
