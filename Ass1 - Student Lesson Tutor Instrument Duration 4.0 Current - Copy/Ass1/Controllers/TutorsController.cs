...
namespace Ass1.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(Ass1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName")] Tutor tutor)
        {
            if (id != tutor.Id)
            {
                return NotFound();
